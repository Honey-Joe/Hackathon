...
const About = () => {
  ...
  return (
    ...
    <>
    <div className="max-w-[100%] mx-auto bg-[#08123B] borde border-" id="about"  >
        <div className="w-[90%] lg:w-[75%] mx-auto grid grid-cols-1 lg:grid-cols-2 py-[115px] gap-7" data-aos="fade-up" data-aos-delay="300">
            <div className="flex flex-col gap-5 items-center lg:items-start">
                ...
                <div className="font-[Fredoka] text-white text-[28px] lg:text-[32px] text-center lg:text-left font-bold">
                    <p>WebSprint'25 <br />A State Level Intercollegiate Hackathon</p>
                </div>
