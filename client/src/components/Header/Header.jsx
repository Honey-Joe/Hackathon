    ...
    <>
      {/* <div className="" id="home">
        <div class="relative w-full h-screen bg-[url(https://ik.imagekit.io/HoneyJoe/Hackathon/army-robots-with-leader.jpg?updatedAt=1736657931131)] bg-cover bg-center">
          ...
          <div className="absolute inset-0 w-[99%] lg:w-[70%] mx-auto grid grid-cols-1">
            <div className="text-white font-bold text-center flex flex-col items-center py-20 justify-center   gap-3">
      ...
      <div className="text-white font-bold text-center flex flex-col items-center py-10 md:py-16 lg:py-20 gap-4">
        ...
        <div className="flex justify-center items-center flex-col gap-5">
          <div>
            ...
            <p className="font-[Poppins] text-center text-[16px] md:text-[20px] pt-3 text-[#fbe072]">
              <span className="text-[14px] md:text-[16px]">on</span> <br />
              05:02:2025
            </p>
          </div>
          <div>
